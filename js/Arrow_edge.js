...
window.Arrow = (function (window, document, undefined) {
    ...
    (function () {
		...
		if(navigator.appVersion.indexOf('Edg') > -1) {
			browser = 'Edg';
			console.log(navigator.appVersion.indexOf('Edg') > -1);
		}
    ...
    function _applyStyleModern(node) {
        ...
        node.style.backgroundImage = 'url("/resource/img/arrow-orange.png")';
    ...
    function _applyStyleIE8(node) {
        ...
        var opacity = 'progid:DXImageTransform.Microsoft.Alpha(opacity=0) ',
            imgSrc = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/resource/img/arrow-orange.png", sizingMethod="scale") ',
     ...
     * Microsoft Edge
     *
     * @method _applyStyleEdg
     * @param node
     * @private
     */
    function _applyStyleEdg(node) {
        node.style.top = '0px';
